...
(function() {
  ...
  init = function() {
    ...
    loader.load('objects/Chair.json', function(geometry, materials) {
      var control;
    ...
    peer.on('open', function(id) {
      ...
      return new QRCode(document.getElementById("qrcode"), "" + location.origin + "/cardboard.html#" + id);
    });
