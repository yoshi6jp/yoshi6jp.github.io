...
(function() {
  var $webgl, URL, animate, camera, clock, controls, effect, fullscreen, init, initCam, initWebgl, lCamCtx, lCamEle, model, rCamCtx, rCamEle, render, renderer, resize, scene, setOrientationControls, update, videoEle, videoPlaying;
